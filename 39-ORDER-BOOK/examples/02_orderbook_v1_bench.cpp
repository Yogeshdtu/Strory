// 02_orderbook_v1_bench.cpp
// ============================================================
// V1 (std::map) ki per-operation LATENCY DISTRIBUTION -- (04-measuring-
// v1.md). Baseline number jo 04/06 se compare hoga.
// ============================================================
//   g++ -std=c++20 -O2 -Wall -Wextra 02_orderbook_v1_bench.cpp -o v1b && ./v1b
// ============================================================
...
int main() {
    ...
    const auto ops = generate_workload(N, /*seed=*/999);
    ...
    std::printf("=== BookV1 (std::map + std::list + unordered_map) ===\n");
